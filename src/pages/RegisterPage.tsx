  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-pink-200 to-blue-100 p-4 relative overflow-hidden">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 w-full max-w-md border border-pink-100 relative z-10">
        ...
        <h1 className="text-3xl font-bold text-center mt-6 mb-2 text-pink-900">Đăng ký</h1>
        <p className="text-center text-pink-600 mb-6">Tạo tài khoản để bắt đầu hành trình của bạn</p>

        <div className="space-y-4">
          <div className="space-y-1.5">
            <Label htmlFor="fullName" className="text-sm font-medium text-pink-700">Họ và tên</Label>
            <Input 
              id="fullName" 
              type="text" 
          ...
          <div className="space-y-1.5">
            <Label htmlFor="confirmPassword" className="text-sm font-medium text-pink-700">Xác nhận mật khẩu</Label>
            <div className="relative">
              <Input
                id="confirmPassword"
          ...
          <div className="pt-2">
            <Button className="w-full bg-pink-500 hover:bg-pink-600 text-white transition duration-200 shadow-md hover:shadow-lg h-11">
              Tạo tài khoản
            </Button>
          </div>
        </div>
        ...
        <div className="flex items-center my-6">
          ...
          <span className="mx-4 text-sm text-pink-500 whitespace-nowrap">hoặc đăng ký bằng</span>
          <div className="flex-grow h-px bg-pink-200"></div>
        </div>
        ...
        <p className="text-center text-sm text-pink-600 mt-6">
          Đã có tài khoản?{" "}
          <Link to="/login" className="text-pink-700 font-medium hover:underline">
            Đăng nhập ngay
          </Link>
        </p>
      </div>
