...
import { ArrowUp, Clock, TrendingUp, User, Package, CreditCard } from "lucide-react";
...
const AdminDashboard = () => {
  return (
    <ScrollArea className="p-6 space-y-8 bg-gradient-to-br from-indigo-50/50 to-purple-50/50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="shadow-lg border-0 bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-500 p-4 pb-12 relative">
          ...
          <Card className="shadow-lg border-0 bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            <CardHeader className="bg-gradient-to-r from-blue-500 to-cyan-500 p-4 pb-12 relative">
          ...
          <Card className="shadow-lg border-0 bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            <CardHeader className="bg-gradient-to-r from-emerald-500 to-teal-500 p-4 pb-12 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
          {/* Sales Overview */}
          <Card className="lg:col-span-2 shadow-lg border-0 bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden">
          ...
          {/* Top Products */}
          <Card className="shadow-lg border-0 bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden">
