    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Quản lý thông tin tài khoản quản trị viên</p>
        </div>
        <Button
            ...
            <CardContent>
              <div className="flex flex-col items-center space-y-4">
                <Avatar className="h-32 w-32">
                  <AvatarImage src="https://i.pravatar.cc/128?img=12" alt="Admin avatar" />
                  <AvatarFallback className="text-2xl bg-gradient-to-br from-blue-500 to-purple-600 text-white">
                    {account.fullName ? account.fullName.slice(0, 2).toUpperCase() : 'AD'}
                  </AvatarFallback>
                </Avatar>
                
                <div className="text-center space-y-2">
                  <h3 className="text-xl font-semibold">{account.fullName || 'Admin'}</h3>
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  ...
                  <Badge 
                    ...
                    className={account.status === 1 ? "bg-green-100 text-green-800" : ""}
                  >
