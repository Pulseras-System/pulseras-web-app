...
const categories = [
  { name: "Tất cả vòng tay", value: "Tất cả", bg: "bg-gradient-to-br from-amber-400 to-amber-600", icon: "✨" },
  { name: "Bohemian", value: "Bohemian", bg: "bg-gradient-to-br from-emerald-400 to-emerald-600", icon: "🌿" },
  { name: "Tinh Thể", value: "Tinh Thể", bg: "bg-gradient-to-br from-blue-400 to-blue-600", icon: "🔮" },
  { name: "Vàng", value: "Vàng", bg: "bg-gradient-to-br from-yellow-400 to-yellow-600", icon: "🌟" },
];
...
const BraceletCard = ({
  ...
  <Link to={`/shop/${id}`} className="group block transition-transform hover:-translate-y-1">
    <div className="relative flex flex-col w-full overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 bg-white">
      <div className="relative overflow-hidden aspect-square">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
          <div className="transform translate-y-6 group-hover:translate-y-0 transition-transform duration-300">
            ...
            <p className="text-zinc-200 mt-1 text-sm">{description}</p>
      ...
      <div className="p-4">
        ...
        <p className="text-amber-600 font-medium mt-2">{price}</p>
      </div>
    </div>
  </Link>
);
...
const ProductPage = () => {
  ...
  return (
    <div className="px-4 sm:px-6 py-8 bg-gradient-to-b from-amber-50 to-white min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 bg-clip-text text-transparent bg-gradient-to-r from-amber-600 to-amber-800">
            Bộ Sưu Tập Vòng Tay
          </h1>
        ...
        <div className="mb-12 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="max-w-md mx-auto mb-6 relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400"
            />
          </div>

          {/* Categories */}
          <div>
            <h2 className="text-2xl font-bold text-center text-gray-800 mb-6 relative inline-block">
              <span className="relative z-10 px-4 bg-white">Danh mục vòng tay</span>
              <span className="absolute bottom-3 left-0 right-0 h-1 bg-amber-100 z-0"></span>
            </h2>
        ...
        {/* Products */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12 relative inline-block">
            <span className="relative z-10 px-4 bg-gradient-to-b from-amber-50 to-white">
              {selectedCategory === "Tất cả" ? "Tất cả sản phẩm" : `Vòng tay ${selectedCategory}`}
            </span>
            <span className="absolute bottom-4 left-0 right-0 h-1 bg-amber-100 z-0"></span>
          </h2>
