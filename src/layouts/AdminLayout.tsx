...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#fff8f0]">
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block w-64 bg-gradient-to-b from-pink-600 to-pink-500 text-pink-50 flex flex-col p-6 space-y-6 fixed h-full border-r border-pink-900/10 shadow-xl">
